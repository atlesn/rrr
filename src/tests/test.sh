...
RRR_POST=../rrr_post
RRR_POST_ARGS="$TEST_SOCKET -c 1 -a be4#int1,be3#int2,be2s#int3,be1#int4,sep1@1,le4@1#aaa,le3#bbb,le2s@1#ccc,le1#ddd,sep2#sep2,blob8@2#blob,msg#msg"

SEND_IP=./send_ip
SEND_IP_PORT=2222

fail () {
	2> echo "Test $1 failed"
	exit 1
}
