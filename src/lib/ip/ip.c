...
#ifdef RRR_HAVE_IP_PKTINFO
	TEST_AND_SET(RRR_IP_SOCKOPT_RECV_PKTINFO_OR_DSTADDR, IPV6_RECVPKTINFO, IP_PKTINFO);
#else
	TEST_AND_SET(RRR_IP_SOCKOPT_RECV_PKTINFO_OR_DSTADDR, IPV6_RECVPKTINFO, IP_RECVDSTADDR);
#endif
