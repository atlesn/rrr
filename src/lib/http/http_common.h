...
#define RRR_HTTP_DATA_RECEIVE_FLAG_IS_HEADERS_END   (1<<0)
#define RRR_HTTP_DATA_RECEIVE_FLAG_IS_DATA_END      (1<<1)
#define RRR_HTTP_DATA_RECEIVE_FLAG_IS_STREAM_CLOSE  (1<<2)
#define RRR_HTTP_DATA_RECEIVE_FLAG_IS_STREAM_ERROR  (1<<3)
