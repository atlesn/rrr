...
#define RRR_UDPSTREAM_BUFFER_MAX 1500
#define RRR_UDPSTREAM_BURST_RECEIVE_MAX 100000
#define RRR_UDPSTREAM_DATA_SIZE_MAX 1024
#define RRR_UDPSTREAM_TIMEOUT_MS 5000
#define RRR_UDPSTREAM_INVALID_TIMEOUT_MS (RRR_UDPSTREAM_TIMEOUT_MS*2)
...
#define RRR_UDPSTREAM_WINDOW_SIZE_MAX RRR_UDPSTREAM_BUFFER_MAX*2
...
#define RRR_UDPSTREAM_FRAME_FLAGS_WINDOW_SIZE	(1<<6)
...
#define RRR_UDPSTREAM_FRAME_IS_WINDOW_SIZE(frame) \
