...
/*
 * Note : Public streaming interface not exposed, expose if needed.
 */
 ...
 */
#define SIZE_OF_SHA_256_HASH RRR_SHA256_SIZE
...
static void sha_256_init(struct Sha_256 *sha_256, uint8_t hash[SIZE_OF_SHA_256_HASH])
{
	sha_256->hash = hash;
...
static void sha_256_write(struct Sha_256 *sha_256, const void *data, size_t len)
{
...
static uint8_t *sha_256_close(struct Sha_256 *sha_256)
{
...
static void calc_sha_256(uint8_t hash[SIZE_OF_SHA_256_HASH], const void *input, size_t len)
{
...
void rrr_sha256_calculate (uint8_t hash[SIZE_OF_SHA_256_HASH], const void *input, size_t len) {
