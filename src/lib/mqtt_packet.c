...
Template functions for broker and client. Each of them doesn't use all the functions.

static int rrr_mqtt_p_handler_connect (RRR_MQTT_PACKET_TYPE_HANDLER_DEFINITION) {
	int ret = 0;
	return ret;
}
static int rrr_mqtt_p_handler_connack (RRR_MQTT_PACKET_TYPE_HANDLER_DEFINITION) {
	int ret = 0;
	return ret;
}
...
static int rrr_mqtt_p_handler_suback (RRR_MQTT_PACKET_TYPE_HANDLER_DEFINITION) {
	int ret = 0;
	return ret;
}
...
static int rrr_mqtt_p_handler_unsuback (RRR_MQTT_PACKET_TYPE_HANDLER_DEFINITION) {
	int ret = 0;
	return ret;
}
...
static int rrr_mqtt_p_handler_pingresp (RRR_MQTT_PACKET_TYPE_HANDLER_DEFINITION) {
	int ret = 0;
	return ret;
}
...
static const struct rrr_mqtt_p_type_properties type_properties[] = {
	...
	{1, 0, rrr_mqtt_p_handler_connack},
	...
	{1, 0, rrr_mqtt_p_handler_suback},
	{1, 2, rrr_mqtt_p_handler_unsubscribe},
	{1, 0, rrr_mqtt_p_handler_unsuback},
	{1, 0, rrr_mqtt_p_handler_pingreq},
	{1, 0, rrr_mqtt_p_handler_pingresp},
