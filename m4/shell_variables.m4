...
dnl Use /usr/bin/echo to avoid problems with -e flag
...
AC_DEFUN([SHELL_VARS_EXPORT], [
	/usr/bin/echo -n $1 >> $SHELL_VARS_FILENAME.in
	/usr/bin/echo -n "=" >> $SHELL_VARS_FILENAME.in
	/usr/bin/echo $2 >> $SHELL_VARS_FILENAME.in
])
